...
//KNOEDELstart
                /* <pyrrh> tell player if his attacker is protected,
                    i.e. retreats if defeated. */
                if(iCombatOdds > 10 * GC.getDefineINT("PYRRH_THRESH-NO-KILL")) {
                    szString.append(NEWLINE);
                    szString.append(gDLL->getText("TXT_KEY_PYRRH_RETREAT"));
                }
                // </pyrrh>
//KNOEDELend
...
/************************************************************************************************/
	...
	if (GC.getGame().getActivePlayer() == AZTECS)
	{
