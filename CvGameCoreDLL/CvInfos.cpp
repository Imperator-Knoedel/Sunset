...
//KNOEDELstart
    return m_iWithdrawalChange
         // pyrrh: boost withdrawal chance granted by promotions (if mod enabled)
        * ((GC.getDefineINT("PYRRH_THRESH-NO-KILL") >= 50) ? GC.getDefineINT("PYRRH_PWITHDRAWAL-BOOST_PERCENT") : 100) / 100;
//KNOEDELend
}
...
//KNOEDELstart
    return m_iWithdrawalProbability
         // pyrrh: boost withdrawal chance (if mod enabled)
        * ((GC.getDefineINT("PYRRH_THRESH-NO-KILL") >= 50) ? GC.getDefineINT("PYRRH_PWITHDRAWAL-BOOST_PERCENT") : 100) / 100;
//KNOEDELend
}
