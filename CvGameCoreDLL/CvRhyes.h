...
#define BEGIN_WONDERS				(163) // increment if normal building (not for wonders) is added	//KNOEDEL: was 164
#define BEGIN_GREAT_WONDERS			(BEGIN_WONDERS+11)	//KNOEDEL: was 12
...
enum DoCBuildings
{
	NATIONAL_THEATRE = BEGIN_WONDERS,	//KNOEDEL: was TRIUMPHAL_ARCH
	TRADING_COMPANY,
